# Created by anton at 31.03.2021
Feature: Create a category in the menu / take a photo with a smartphone camera
  # Enter feature description here

  Scenario: Create a category in the menu / take a photo with a smartphone camera
