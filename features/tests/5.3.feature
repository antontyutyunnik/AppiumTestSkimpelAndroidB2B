# Created by anton at 04.04.2021
Feature: Add a product to a category / take a photo using a smartphone camera
  # Enter feature description here

  Scenario: Add a product to a category / take a photo using a smartphone camera
